...
const login = (req, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!validation) {
        next(new customerror_1.CustomeError('User name or password is incorrecct', 404));
    }
    else {
...
const userFinding = (next) => __awaiter(void 0, void 0, void 0, function* () {
...
const userById = (req, next) => __awaiter(void 0, void 0, void 0, function* () {
