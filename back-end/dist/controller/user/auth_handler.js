...
const qundityIncre = (0, asyncHandler_1.default)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const cart = yield cartModel_1.CartModel.findOne({ userId: req.params.id });
