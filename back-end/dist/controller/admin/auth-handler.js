...
const login = (0, asyncHandler_1.default)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const response = yield auth_controller_1.admin_srvc.login(req, next);
    res.status(200).json({
        status: "Success",
...
const users = (0, asyncHandler_1.default)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const users = yield auth_controller_1.admin_srvc.userFinding(next);
    res.status(200).json({
...
const userById = (0, asyncHandler_1.default)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const user = yield auth_controller_1.admin_srvc.userById(req, next);
    res.status(200).json({
        status: 'success',
